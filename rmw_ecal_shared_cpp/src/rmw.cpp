...
namespace eCAL {
    namespace rmw {
        ...
        rmw_ret_t
        rmw_node_assert_liveliness(const char * /* implementation_identifier */, const rmw_node_t * /* node */) {
            UNSUPPORTED;
        }

        const rmw_guard_condition_t *
        rmw_node_get_graph_guard_condition(const char *implementation_identifier, const rmw_node_t *node) {
        ...
        rmw_ret_t
        rmw_destroy_publisher(const char *implementation_identifier, rmw_node_t *node, rmw_publisher_t *publisher) {
            RMW_CHECK_ARGUMENT_FOR_NULL(node, RMW_RET_INVALID_ARGUMENT);
        ...
        rmw_ret_t rmw_destroy_subscription(const char *implementation_identifier, rmw_node_t *node,
        ...
        rmw_ret_t rmw_take_serialized_message_with_info(const char *implementation_identifier,
                                                        ...
                                                        rmw_message_info_t * /* message_info */,
                                                        rmw_subscription_allocation_t *allocation) {
            return rmw_take_serialized_message(implementation_identifier, subscription, serialized_message, taken,
                                               allocation);
        }
        ...
        rmw_create_guard_condition(const char *implementation_identifier, rmw_context_t *context) {
            RMW_CHECK_ARGUMENT_FOR_NULL(context, nullptr);
            CHECK_RMW_IMPLEMENTATION_RET_VALUE(implementation_identifier, context, nullptr);
        ...
        rmw_ret_t
        rmw_destroy_guard_condition(const char *implementation_identifier, rmw_guard_condition_t *guard_condition) {
        ...
        rmw_ret_t rmw_trigger_guard_condition(const char *implementation_identifier,
        ...
        rmw_wait_set_t *rmw_create_wait_set(const char *implementation_identifier, rmw_context_t *context,
        ...
        rmw_ret_t rmw_get_gid_for_publisher(const char *implementation_identifier, const rmw_publisher_t *publisher,
                                            rmw_gid_t *gid) {
            RMW_CHECK_ARGUMENT_FOR_NULL(publisher, RMW_RET_INVALID_ARGUMENT);
        ...
        rmw_ret_t
        rmw_compare_gids_equal(const char *implementation_identifier, const rmw_gid_t *gid1, const rmw_gid_t *gid2,
                               bool *result) {
...
// required functions for HUMBLE
        ...
        rmw_ret_t
        rmw_subscription_get_content_filter(const rmw_subscription_t *subscription, rcutils_allocator_t *allocator,
        ...
        rmw_ret_t
        rmw_subscription_set_on_new_message_callback(rmw_subscription_t *subscription, rmw_event_callback_t callback,
                                                     const void *user_data) {
            UNSUPPORTED; // OK
        }
