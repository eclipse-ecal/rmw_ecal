...
namespace eCAL
{
  namespace rmw
  {
    ...
    class CppServiceTypeSupport : public ServiceTypeSupport
    {
      ...
      const rosidl_typesupport_introspection_cpp::ServiceMembers *GetMembers() const
      {
        return GetCppMembers(type_support_);
      }

    public:
      explicit CppServiceTypeSupport(const rosidl_service_type_support_t *type_support)
