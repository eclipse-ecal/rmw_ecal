...
{
  return eCAL::rmw::rmw_publisher_get_network_flow_endpoints(publisher, allocator, network_flow_endpoint_array);
}
...
rmw_ret_t rmw_subscription_get_network_flow_endpoints(const rmw_subscription_t *subscription,
                                                      ...
                                                      rmw_network_flow_endpoint_array_t *network_flow_endpoint_array)
{
  return eCAL::rmw::rmw_subscription_get_network_flow_endpoints(subscription, allocator, network_flow_endpoint_array);
}
