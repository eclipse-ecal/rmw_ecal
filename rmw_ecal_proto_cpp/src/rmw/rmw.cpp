...
rmw_publisher_t *rmw_create_publisher(const rmw_node_t *node,
    ...
    return eCAL::rmw::rmw_create_publisher(::rmw_get_implementation_identifier(), eCAL::rmw::ProtoTypeSupportFactory{},
...
rmw_ret_t rmw_serialize(const void *ros_message,
    ...
    return eCAL::rmw::rmw_serialize(::rmw_get_implementation_identifier(), eCAL::rmw::ProtoSerializerFactory{},
...
rmw_ret_t rmw_deserialize(const rmw_serialized_message_t *serialized_message,
                          const rosidl_message_type_support_t *type_support,
                          void *ros_message) {
    return eCAL::rmw::rmw_deserialize(::rmw_get_implementation_identifier(), eCAL::rmw::ProtoSerializerFactory{},
...
rmw_subscription_t *rmw_create_subscription(const rmw_node_t *node,
    ...
    return eCAL::rmw::rmw_create_subscription(::rmw_get_implementation_identifier(),
                                              eCAL::rmw::ProtoTypeSupportFactory{}, node, type_support, topic_name,
...
rmw_client_t *rmw_create_client(const rmw_node_t *node,
                                ...
                                const rmw_qos_profile_t *qos_policies) {
    return eCAL::rmw::rmw_create_client(::rmw_get_implementation_identifier(), eCAL::rmw::ProtoTypeSupportFactory{},
...
rmw_service_t *rmw_create_service(const rmw_node_t *node,
                                  ...
                                  const char *service_name,
                                  const rmw_qos_profile_t *qos_policies) {
    return eCAL::rmw::rmw_create_service(::rmw_get_implementation_identifier(), eCAL::rmw::ProtoTypeSupportFactory{},
                                         node, type_support, service_name, qos_policies);
}
